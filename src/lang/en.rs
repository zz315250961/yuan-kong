...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("verify_rustdesk_password_tip",
         "Password required for device ID %s. Please verify its password."),
        ("Permanent password", "Permanent password"),
        ("Set", "Set"),
        ("Not set", "Not set"),
        ("Permanent password cannot be copied",
         "The permanent password is stored encrypted and cannot be copied."),
        ("Please login first", "Please log in first"),
        ("Cannot connect to self", "You cannot connect to your own device."),
        ("Recording started", "Screen recording started."),
        ("Recording stopped at",
         "Screen recording stopped. File saved to %s"),
        ("toolbar_pin", "Pin"),
        ("toolbar_mobile_actions", "Actions"),
        ("toolbar_monitor", "Monitors"),
        ("toolbar_control", "Control"),
        ("toolbar_display", "Display"),
        ("toolbar_keyboard", "Keyboard"),
        ("toolbar_chat", "Chat"),
        ("toolbar_voice", "Voice"),
        ("toolbar_record", "Record"),
        ("toolbar_close", "Disconnect"),
