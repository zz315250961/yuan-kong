...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 LinkRemote 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 LinkRemote \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 LinkRemote \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("Password at least 4 characters", "密码至少 4 位"),
        ("Passwords do not match", "两次输入的密码不一致"),
        ("Please enter the verification code", "请输入验证码"),
        ("Verification code sent", "验证码已发送"),
        ("Sent", "已发送"),
        ("Password reset, please login with new password", "密码已重置，请使用新密码登录"),
        ("Registration successful, logged in automatically", "注册成功，已自动登录"),
        ("Email changed successfully", "邮箱已更换成功"),
        ...
        ("Set", "已设置"),
        ("Not set", "未设置"),
        ("Permanent password cannot be copied", "固定密码为加密存储，无法复制"),
        ("Please login first", "请先登录账号"),
        ("Cannot connect to self", "不能连接自己的设备"),
        ("Recording started", "已开始录屏"),
        ("Recording stopped at", "录屏已结束，文件已保存到 %s"),
        ("Verify", "验证"),
        ("Remember me", "记住我"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 LinkRemote 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [LinkRemote Input] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 LinkRemote 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 LinkRemote 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 LinkRemote \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 LinkRemote \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 LinkRemote 的 UAC 窗口点击确认。"),
        ...
        ("Maximize", "最大化"),
        ("Your Device", "你的设备"),
        ("empty_recent_tip", "最近访问过：你最近连接过的设备会显示在这里"),
        ("empty_favorite_tip", "收藏：你收藏的设备会显示在这里，便于快速连接"),
        ("empty_lan_tip", "已发现：同一网络下自动发现的设备会显示在这里"),
        ("empty_address_book_tip", "地址：你保存过的设备会显示在这里"),
        ("empty_group_tip", "可访问设备：同一账号下可访问的设备会显示在这里"),
        ("Empty Username", "空用户名"),
        ("Empty Password", "空密码"),
        ("Me", "我"),
        ...
        ("verify_rustdesk_password_tip", "连接设备 ID %s 需要密码，请验证 %s 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 LinkRemote 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，LinkRemote 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("powered_by_me", "由 LinkRemote 提供支持"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 LinkRemote 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 LinkRemote 后台服务"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 LinkRemote 客户端升级至版本 {} 或更新版本！"),
